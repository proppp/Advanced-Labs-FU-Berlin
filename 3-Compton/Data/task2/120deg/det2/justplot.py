...
def plot_spectra_in_folder(folder_path):
    """
    Reads all spectrum files in a folder, scales their data, and plots their spectra.
    ...
    for file in files:
        ...
        try:
            ...
            plt.plot(channels, scaled_counts, label=file)
        except Exception as e:
            print(f"Error processing file {file}: {e}")

    plt.title("Scaled Spectra from Folder")
    plt.xlabel("Channel")
