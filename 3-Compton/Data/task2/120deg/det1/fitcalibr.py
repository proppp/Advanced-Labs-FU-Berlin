...
def plot_all_spectra_with_fits(folder_path, fitting_ranges):
    """
    Plots all spectra and their Gaussian fits together in a single plot with reduced alpha.
...
def plot_all_spectra_with_fits(folder_path, fitting_ranges):
    ...
    # Save plot as a PDF
    output_filename = "spectra_fits_120deg.pdf"
...
folder_path = "."
fitting_ranges = {
    "Na 120deg cut below": (200, 400),  # Example range in keV
    "Na 120deg cut above": (108, 482)  # Example range in keV
}
