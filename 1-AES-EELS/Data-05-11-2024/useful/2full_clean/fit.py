...
def plot_and_correct_energy(folder_path, ranges, fixed_peak_value=1393.5):
    ...
    for file_name in txt_files:
        ...
        if data:
            ...
            plt.title("Data and Gaussian Derivative Fits for the Cleaned Sample")
            ...
            for i, x_range in enumerate(ranges):
                ...
                if not df_range.empty:
                    try:
                        ...
                        print(f"  A = {A}, mu = {mu:.2f} ± {mu_error:.2f}, sigma = {sigma}")
...
ranges = [(58, 100), (0, 0), (0, 0), (1368, 1377)]  # Specify the four ranges here
