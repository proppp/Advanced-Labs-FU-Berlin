...
def fit_al_kll_peaks_with_baseline(file_path):
    ...
    if data:
        ...
        plt.title("Data and Gaussian Derivative Fits Al Bulk Plasmons")
        ...
        # Fit and plot each peak in the specified ranges
        ...
        for i, peak in enumerate(peak_info):
            ...
            adjusted_range = (peak['range'][0] + shift_value, 1020)
